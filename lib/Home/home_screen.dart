...
class HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    productFuture = ApiService().fetchProductData(1, 10);
  }
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ////no data found/////////////////////////////////////////////////
                        searchFilteredProducts.isEmpty && searchController.text.isNotEmpty
                            ? Column(
                                children: [
                                ...
                                child: FutureBuilder<List<Products>>(
                                  ...
                                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                                    if (snapshot.hasError) {
                                      ...
                                      var displayProducts = searchFilteredProducts.isEmpty ? products : searchFilteredProducts;
